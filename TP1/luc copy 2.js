...
function slideAutoAnimation(e){
    ...
    setTimeout(slideAutoAnimation, parseInt(e.attr('slide_time')[0]), e);
}
...
class LucComponent{
    ...
    slide(){
        ...
        for(var i in this.obj_luc.elements){
            ...
            e.append('<button class="luc-slide-button-on-off"></button>');
            ...
            for(var j in sc.children('div').elements)
                e.children('.luc-slides-buttons-container').append('<button class="luc-slide-button" slide_move="'+ j +'"></button>');
            
            
            e.children('.luc-slides-buttons-container').children('.luc-slide-button').elements[0].style('backgroundColor', 'black');
            e.children('.luc-slides-buttons-container').children('.luc-slide-button').click(function(){
                ...
                $luc(this).parent().children('button').animation({'backgroundColor':'red'}, 500);
                $luc(this).animation({'backgroundColor':'black'}, 500);
